...
function getIncome(){
  ...
  var testmajor = $("#majors :selected").val();
  ...
  document.getElementById('output').innerHTML = "A " + testmajor + " major at " + collegename + " would make $" + Math.round(scalefactor*majorearningdata[testmajor],2) + ".";
